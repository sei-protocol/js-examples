			...
			<div className='cardContent'>
				<div className='radioGroup'>
					<label className='radioLabel'>
						<input type='radio' value='query' className='radioItem' checked={selectedOption === 'query'} onChange={handleChange} />
						Query
					</label>
					<label className='radioLabel'>
						<input type='radio' value='execute' className='radioItem' checked={selectedOption === 'execute'} onChange={handleChange} />
						Execute
					</label>
				</div>
				...
				{selectedOption === 'execute' && (
					<div className='labelInput'>
						...
						<input autoFocus={true} placeholder='Gas price...' className='input' value={gasPrice} onChange={(e) => setGasPrice(e.target.value)} />
					</div>
				)}
				{selectedOption === 'execute' && (
					<div className='labelInput'>
						<p className='label'>gas limit:</p>
						<input autoFocus={true} placeholder='Gas limit...' className='input' value={gasLimit} onChange={(e) => setGasLimit(e.target.value)} />
					</div>
				)}
				{selectedOption === 'execute' && (
					<div className='labelInput'>
						<p className='label'>memo:</p>
						<input autoFocus={true} placeholder='Memo...' className='input' value={memo} onChange={(e) => setMemo(e.target.value)} />
					</div>
				)}
				{selectedOption === 'execute' && (
					<div className='labelInput'>
				...
				<button className='walletButton' onClick={sendContractCall}>
					{selectedOption}
				</button>
